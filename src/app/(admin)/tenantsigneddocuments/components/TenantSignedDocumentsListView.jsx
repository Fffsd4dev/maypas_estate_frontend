...
// const TenantSignedDocumentsListView = ({ documents, onViewClick, onDownloadClick }) => {
...
// export default TenantSignedDocumentsListView;
...
const TenantSignedDocumentsListView = ({ documents, onViewClick }) => {
  // Function to get file icon based on filename
  const getFileIcon = (filename) => {
    const extension = filename?.split('.').pop()?.toLowerCase() || '';
