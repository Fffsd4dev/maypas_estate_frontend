...
//     try {
//       // Try landlord registration first
//       let response = await axios.post(
//         `${import.meta.env.VITE_BACKEND_URL}/api/${tenantSlug}/landlord/register`,
//         formData,
//         {
//           headers: {
...
//       // If landlord registration succeeds, redirect to landlord dashboard
//       if (response.data) {
//         const sessionData = {
//           token: response.data.token,
//           user: response.data.landlord || response.data.user,
//           userType: 'landlord'
//         };
...
//     } catch (landlordError) {
//       // If landlord registration fails, try tenant registration
//       try {
...
//         if (tenantError.response?.status === 409 || landlordError.response?.status === 409) {
//           setError("User with this email already exists.");
//         } else if (tenantError.response?.status === 400 || landlordError.response?.status === 400) {
//           setError("Invalid registration data.");
//         } else {
//           setError(tenantError.response?.data?.message || "Registration failed. Try again.");
//         }
