      ...
      <div className="container-xxl">
        <div className="navbar-header">
          ...
          <div className="d-flex align-items-center gap-1">
            ...
            {/* Login URL Section - full detail on tablet/desktop */}
            ...
            {/* Login URL Section - compact button on mobile */}
            <div className="d-flex d-md-none" style={{ flex: 1, justifyContent: 'center', padding: '0 8px', minWidth: 0 }}>
              <button
                onClick={handleCopyUrl}
                style={{
                  background: copySuccess ? '#28a745' : '#f8f9fa',
                  border: '1px solid #e9ecef',
                  borderRadius: '8px',
                  padding: '6px 14px',
                  cursor: 'pointer',
              ...
              >
                ...
                <span style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {copySuccess ? 'Copied!' : `Copy ${getLoginUrlLabel()}`}
                </span>
              </button>
            </div>
