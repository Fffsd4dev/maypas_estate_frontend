...
import ComplaintDetailsPage from '@/app/(admin)/tenantcomplaints/components/ComplaintDetailsPage';
import MaintenanceDetailsPage from '@/app/(admin)/maintenancecomplaints/components/MaintenanceDetailsPage';
...
const UnsignedDocuments = lazy(() => import('@/app/(admin)/unsigneddocuments/page'));
const SignedDocuments = lazy(() => import('@/app/(admin)/signeddocuments/page'));
const TenantUnsignedDocuments = lazy(() => import('@/app/(admin)/tenantunsigneddocuments/page'));
const TenantSignedDocuments = lazy(() => import('@/app/(admin)/tenantsigneddocuments/page'));
...
const tenantRoutes = [{
  ...
  name: 'Unsigned Documents',
  path: '/:tenantSlug/documents/unsigned',
  element: withSuspense(UnsignedDocuments),
  isPublic: false,
  roles: ['admin', 'landlord'] // Example role-based access
}, {
  name: 'Unsigned Documents',
  path: '/:tenantSlug/tenant-documents/unsigned',
  element: withSuspense(TenantUnsignedDocuments),
  isPublic: false,
  roles: ['tenant'] // Example role-based access
}, {
  name: 'Signed Documents',
  path: '/:tenantSlug/documents/signed',
  element: withSuspense(SignedDocuments),
  isPublic: false,
  roles: ['admin', 'landlord'] // Example role-based access
}, {
  name: 'Signed Documents',
  path: '/:tenantSlug/tenant-documents/signed',
  element: withSuspense(TenantSignedDocuments),
  isPublic: false,
  roles: ['tenant'] // Example role-based access
}, {
  name: 'Estate Managers',
  ...
  path: '/:tenantSlug/properties/tenant-complaint-details/:complaintId',
  element: withSuspense(ComplaintDetailsPage),
  isPublic: false,
  roles: ['admin', 'estate-manager']
}, {
  name: 'Maintenance Details',
  path: '/:tenantSlug/properties/tenant-maintenance-details/:maintenanceId',
  element: withSuspense(MaintenanceDetailsPage),
  isPublic: false,
  roles: ['admin', 'estate-manager']
}, {
  name: 'Maintenance',
